...
class Categories extends CI_Controller {
	...
	public function getCategoriesFollowing() {
		$this->load->model('Index_model');
		$results = $this->Index_model->get_categories_following($this->session->userdata('userid'));
		header('Access-Control-Allow-Origin: *');
        header("Content-Type: application/json");
        $data = array('response'=>true, 'results'=>$results);
